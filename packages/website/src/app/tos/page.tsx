      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-8 py-16">
        ...
        <div className="flex flex-col gap-6 text-sm text-zinc-300 leading-relaxed font-medium">
          <section className="bg-[#16161a] border-2 border-zinc-800 rounded-2xl p-6 shadow-[5px_5px_0px_0px_rgba(0,0,0,0.4)]">
            <h2 className="text-base font-black text-white mb-2 uppercase">1. Nature of the Software</h2>
            <p>
          ...
          <section className="bg-[#16161a] border-2 border-zinc-800 rounded-2xl p-6 shadow-[5px_5px_0px_0px_rgba(0,0,0,0.4)]">
            <h2 className="text-base font-black text-white mb-2 uppercase">2. Self-Hosting & Account Safety</h2>
            <p>
          ...
          <section className="bg-[#16161a] border-2 border-zinc-800 rounded-2xl p-6 shadow-[5px_5px_0px_0px_rgba(0,0,0,0.4)]">
            <h2 className="text-base font-black text-white mb-2 uppercase">3. Compliance with Third-Party Terms</h2>
            <p>
          ...
          <section className="bg-[#16161a] border-2 border-zinc-800 rounded-2xl p-6 shadow-[5px_5px_0px_0px_rgba(0,0,0,0.4)]">
            <h2 className="text-base font-black text-white mb-2 uppercase">4. Noncommercial Restrictions</h2>
            <p>
          ...
          <section className="bg-[#16161a] border-2 border-zinc-800 rounded-2xl p-6 shadow-[5px_5px_0px_0px_rgba(0,0,0,0.4)]">
            <h2 className="text-base font-black text-white mb-2 uppercase">5. Disclaimer of Warranties</h2>
            <p>
